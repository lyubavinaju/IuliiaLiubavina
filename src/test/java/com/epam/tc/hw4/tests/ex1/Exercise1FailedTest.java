...
public class Exercise1FailedTest extends Exercise1 {

    @Test(dataProvider = "exercise1Data", dataProviderClass = Exercise1Data.class)
    void exercise1FailedTest(String name, String password, String username,
        ...
        softAssertions.fail("Manually failed");
